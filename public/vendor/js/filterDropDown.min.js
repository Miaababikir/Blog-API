!function (t) {
    function e(t) {
        var e = {columns: [], columnsIdxList: [], bootstrap: !1, autoSize: !0, label: "فلاتر : "};
        if ("bootstrap" in t && "boolean" == typeof t.bootstrap && (e.bootstrap = t.bootstrap), "autoSize" in t && "boolean" == typeof t.autoSize && (e.autoSize = t.autoSize), "label" in t && "string" == typeof t.label && (e.label = t.label), "columns" in t) for (var i = 0; i < t.columns.length; i++) {
            var n = t.columns[i];
    ...
    t(document).on("preInit.dt", function (i, n) {
        if ("dt" === i.namespace) {
            var o = new t.fn.dataTable.Api(n), a = o.table().node().id, l = o.init();
            if ("filterDropDown" in l) {
                var r = e(l.filterDropDown);
                if (0 != r.columns.length) {
                    var u = o.table().container(), s = a + "_filterWrapper",
                        c = s + " form-inline";
                    t(u).prepend('<div id="' + s + '" class="' + c + '">' + r.label + "</div>"), o.columns(r.columnsIdxList).every(function () {
                        ...
                        "" == i && (i = "column " + (e + 1));
                        var n = "form-control input-large " + a + "_filterSelect", o = a + "_filterSelect" + e;
                        t("#" + s).append('<select id="' + o + '" class="' + n + '"></select>');
                        var l = t("#" + o).empty().append('<option value="">(' + i + ")</option>");
                        r.autoSize && r.columns[e].autoSize && screen.width > 768 && l.css("max-width", l.outerWidth()), null !== r.columns[e].maxWidth && l.css("max-width", r.columns[e].maxWidth)
                    })
                }
            }
        }
        ...
        if ("dt" === i.namespace) {
            ...
            if ("filterDropDown" in l) {
                ...
                o.columns(r.columnsIdxList).every(function () {
                    var e = this, i = e.index(), n = t("#" + (a + "_filterSelect" + i));
